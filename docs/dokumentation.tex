...
10s!
\begin{itemize}
\item Oder für jede Güterart einzeln 1D. Abfragen: 2 pro Güterart und Land,
also ca $6\cdot150=900$ für alle.
\item 2D pro Land geht auf jeden Fall: Die beiden Achsen sind Güterart und
Zeit+pk. Abfragen: 4 pro Land, also ca. $4\cdot150=600$ für alle.
...
\item 2 Abfragen, 1 Subtraktion pro Landund beliebiger Zeitraum
\end{itemize}
\end{itemize}

...
\item Ländertotal vs einzelne Geschäfte (später, erst nur Ländertotale)
\item Zeitauswahl
\item sortieren nach
\begin{itemize}
\item Betrag aufwärts/abwärts
\item neu/alt nicht bei Ländertotalen, nur bei einzelnen Geschäften (später,
erst wenn hier auch einzelne Geschäfte implementiert sind)
\end{itemize}
...
\item Filter Güterauswahl: Kriegsmaterial, Kriegsmaterial ohne besondere
miliärische Güter, besondere militärische Güter, Dual Use, Embargo
...
\begin{itemize}
\item eine für jede Tabellenart von oben, die als get-Parameter alle relevanten
Filterparameter unterstützt
\begin{itemize}
...
vorerst nur diejenigen die in der alten Datenbank noch nicht sind
\begin{enumerate}
\item von der Webseite
\item vielleicht Kontakt aufnehmen und schauen ob es noch mehr gibt
\end{enumerate}
\item Die Daten aus der neuen in die alte Datenbank kopieren, damit mittelfristig
die Webseite wieder auf dem neuen Stand ist
\item Die Webseite für die neue Datenbank bauen/anpassen
\end{enumerate}
